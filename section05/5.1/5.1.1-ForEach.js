...
let phrases =[];
data.forEach(user =>{
  phrases.push(user.company.catchPhrase, `${user.company.catchPhrase}`)
});
...
classWeeks.forEach((htmlElement, index) => htmlElement.textContent =  `updated text in index : ${index}`);

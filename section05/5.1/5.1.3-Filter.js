...
//filter for user 6's completed task
let userSixCompetedTask = data.filter(task => task.userId ==6 && task.completed == true);
console.log(userSixCompetedTask);
// filter for tasks with a title less than 24 characters long
let taskTitle = data.filter(task => task.title.length < 24);
